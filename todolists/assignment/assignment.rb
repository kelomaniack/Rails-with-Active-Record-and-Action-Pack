...
class Assignment
  ...
  def create_user(params)
    ...
    User.create(username: params[:name], password_digest: params[:password_digest])
  end
  ...
  def create_todolist(params)
    ...
    # return an instance of the class with primary key (`id`), and dates (`created_at` and `updated_at`) assigned
    TodoList.create(name: params[:name], due_date: params[:due_date])
  end
  ...
  def find_alllists(offset, limit)
    ...
    TodoList.all.order(updated_at: :desc).offset(offset).limit(limit)
  end
